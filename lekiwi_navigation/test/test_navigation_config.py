...
# collision_toggle.yaml moved to lekiwi_control/config/base/ - its node now runs inside
# lekiwi_control's control_support_node, not here. See test_control_config.py.
